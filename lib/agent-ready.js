...
export function inferCapabilities(input={}){
  const report=normalizeScanReport(input),pages=Array.isArray(report.pages)?report.pages:[],signals=report.signals||{},actions=report.actions||[],prices=report.prices||[],types=report.schemaTypes||[],caps=[];
